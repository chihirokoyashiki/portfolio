...
document.addEventListener("DOMContentLoaded", () => {
  ...
  closeButtons.forEach(close => {
   ...
   const toggleBtn = document.querySelector(".header_togglebtn");
    ...
    const navMask = document.querySelector(".header_nav_mask");

    toggleBtn.addEventListener("click", function () {
        toggleBtn.classList.toggle("open");
        headerNav.classList.toggle("nav_open");
        navMask.style.display = headerNav.classList.contains("nav_open") ? "block" : "none";
    });

    navMask.addEventListener("click", function () {
        toggleBtn.classList.remove("open");
        headerNav.classList.remove("nav_open");
        navMask.style.display = "none";
    });

    // メニュー内リンクをクリックした時にもメニューを閉じる
    const menuLinks = document.querySelectorAll(".nav_menu_a");
...
const about_Hum = document.querySelectorAll(".hum_about");
about_Hum.forEach(btn => {
  btn.style.cursor = "pointer";
  btn.addEventListener("click", () => {
    window.location.href = "about.html";
  });
...
const works_Hum = document.querySelectorAll(".hum_works");
works_Hum.forEach(btn => {
  btn.style.cursor = "pointer";
  btn.addEventListener("click", () => {
    window.location.href = "works.html";
  });
...
const news_Hum = document.querySelectorAll(".hum_news");
news_Hum.forEach(btn => {
  btn.style.cursor = "pointer";
  btn.addEventListener("click", () => {
    window.location.href = "news.html";
  });
...
const contact_Hum = document.querySelectorAll(".hum_content");  // ← クラス名は .hum_content なので修正
contact_Hum.forEach(btn => {
  btn.style.cursor = "pointer";
  btn.addEventListener("click", () => {
    window.location.href = "contact.html";
  });
